(function (global) {
    ...
    // 1. Outer Card: bg-teal-lighten-5 (สีธีม Contact)
    // 2. Inner Sheet: bg-grey-lighten-5 (สีเทาอ่อน)
    // 3. Inputs: bg-white (สีขาว)
    // --------------------------------------------------------

    const template = `
      <v-card id="section-lead-contact"
          variant="outlined"
          rounded="xl"
          class="section-card section-card--lead-contact bg-teal-lighten-5">
