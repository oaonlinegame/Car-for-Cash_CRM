(function (global) {
    ...
    // ปรับปรุง UI:
    // 1. ใช้ธีม Amber ตามโค้ดต้นฉบับเพื่อให้ Chip และ Background สีตรงกัน
    //    - Card: bg-amber-lighten-5
    //    - Chip: amber-lighten-4
    // 2. ใช้โครงสร้าง Double Layer (Outer Card > Grey Sheet > White Input)
    // --------------------------------------------------------

    const template = `
      <v-card id="section-lead-source"
          variant="outlined"
          rounded="xl"
          class="section-card section-card--lead-prospect bg-deep-purple-lighten-5">
          
          <v-card-title class="py-3">
              <div class="d-flex align-center">
                  <v-avatar size="30" color="deep-purple-lighten-4" class="mr-3">
                      <v-icon size="small" icon="mdi-bullhorn-outline" color="deep-purple-lighten-1"></v-icon>
                  </v-avatar>
                  <div>
                  ...
                  <v-row dense class="form-row mt-2"
                      ...
                      <v-col cols="12" md="5">
                          <v-text-field type="date" label="วันที่จัดงาน"
                              ...
                              variant="outlined" bg-color="white" color="primary" hide-details="auto">
                          </v-text-field>
                      </v-col>
                  </v-row>
