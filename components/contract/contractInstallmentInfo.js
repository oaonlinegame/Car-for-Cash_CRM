(function (global) {
    ...
    // --------------------------------------------------------
    // 📅 CONTRACT INSTALLMENT INFO COMPONENT
    // --------------------------------------------------------
    // ปรับปรุง UI (Layered Design):
    // 1. Outer Card: bg-deep-purple-lighten-5 (ธีมผ่อนชำระ)
    // 2. Inner Sheet: bg-grey-lighten-5 (พื้นเทา)
    // 3. Inputs: bg-white (ช่องขาว)
    // --------------------------------------------------------

    const template = `
      <v-card :id="'section-contract-installment-' + index"
          variant="outlined"
          rounded="xl"
          class="section-card section-card--installment mb-4 bg-deep-purple-lighten-5">
                  ...
                  <v-row dense class="mb-2 form-row">
                      ...
                      <v-col cols="6" sm="3">
                           <v-text-field label="คงเหลือ (งวด)" type="number"
                              ...
                              variant="outlined" bg-color="grey-lighten-4" density="compact"
                  ...
                  <v-row dense class="mt-1 form-row">
                      <v-col cols="12">
                          <v-textarea v-model="contract.note"
                              ...
                              rows="2" auto-grow variant="outlined" bg-color="white" density="compact"
